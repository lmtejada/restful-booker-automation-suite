...
- Name: api/functional/booking-create.spec.ts >> create booking — POST /booking >> [TC-009]: returns a 500 for a text/plain Content-Type instead of a 4xx
- Location: tests/api/functional/booking-create.spec.ts:132:13
