...
- Name: api/functional/booking-retrieve.spec.ts >> retrieve bookings — GET /booking & GET /booking/:id >> [TC-016]: returns Content-Type: application/xml for an XML response
- Location: tests/api/functional/booking-retrieve.spec.ts:165:13
