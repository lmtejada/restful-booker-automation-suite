...
- Name: api/functional/booking-create.spec.ts >> create booking — POST /booking >> [TC-008]: accepts an illogical date range where checkin is after checkout
- Location: tests/api/functional/booking-create.spec.ts:98:13
